...
/*
 * Corresponding hashes for the test messages
 */
static char *val[] =
{
    // ""
    ...
    // NULL
    "fb329000228cc5a24c264c57139de8bf" \
    "854fc86fc18bf1c04ab61a2b5cb4b921"
};

int main(int argc, char** argv)
{
    sha2_serial(true, argv[1], 25);
    return EXIT_SUCCESS;
}
...
void sha2_serial(bool run_benchmark, char *file_name, int number_runs)
{
    ...
    if(run_benchmark)
    {
        ...
        printf("sha256 took %d seconds, %d milliseconds", average / 1000, average % 1000);
    }
    else
    {
        printf("\n SHA2-256 Validation Tests:\n\n");
        for(i = 0; i < 6; i++)
        {
            printf("Test %d ", i + 1);
            sha256_starts(&ctx);
